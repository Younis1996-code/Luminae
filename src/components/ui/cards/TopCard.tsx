...
const TopCard = ({
  ...
  return (
    <div className="flex flex-col items-center w-full rounded-lg shadow-[0_0_12px_0_rgba(0,0,0,0.1)] space-y-5 min-w-[200px] transition-all hover:scale-[1.02] bg-white">
      {/* Product Image */}
      <div className="relative w-full min-h-[327px]">
        <Image
          src={image}
      ...
      {/* Content */}
      <div className="flex flex-col space-y-3 px-5 w-full pb-4">
        <div className="flex justify-between items-start">
          <div className="flex flex-col">
            <Heading level={3} size="h12" weight="bold" lineH="lh20">
              {brand}
            </Heading>
            <Paragraph
              size="p10"
        ...
        {/* Rating & Price */}
        <RatingStars num={rating} size={6} />
        <PriceBox oldPrice={oldPrice} newPrice={price} plainDiscount />
      </div>
    </div>
  );
};
