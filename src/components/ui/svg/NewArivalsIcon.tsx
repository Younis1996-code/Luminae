...
const NewArivalsIcon = ({ className, hoverClassName, color= "white" }: IconProps) => {
  return (
    <div>
      <svg
        width="16"
      ...
      >
        <g clip-path="url(#clip0_1053_17888)">
          <path
