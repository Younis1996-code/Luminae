...
const FooterCard = ({ className }: Props) => {
  ...
  return (
    <div
      className={`py-8 px-[60px] rounded-lg bg-mBlue-500 flex flex-col items-center gap-6 ${className}`}
    >
      ...
      <div className="flex relative border-0 bg-white rounded-sm w-[60%]">
        <input
          ...
          className="bg-transparent px-3 py-2 text-sm focus-within:outline-0 focus-within:border-0 w-[90%]"
        />
        <button
